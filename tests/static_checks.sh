...
grep -q -- '--include=optional' "$repo_root/ansible/roles/harnesses/tasks/install.yml"
...
grep -q 'package: "@agentclientprotocol/codex-acp"' "$repo_root/ansible/group_vars/all/harnesses.yml"
grep -q 'command: codex-acp' "$repo_root/ansible/group_vars/all/harnesses.yml"
